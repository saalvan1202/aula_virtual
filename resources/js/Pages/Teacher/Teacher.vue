                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control"
                                    ...
                                    :class="{'is-invalid':errors.id_tipo_contrato}"
                                >
                                    <option v-for="option in tipo_contratos" :key="option.id" :value="option.id">
                                        {{option.descripcion}}
                                    </option>
                                </select>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" v-model="form.profesion"
                                    :class="{'is-invalid':errors.profesion}"
                                    v-input-upper
                                >
                                <InputError :error="errors.profesion"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
export default{
    components: {FormPerson,LayoutContent, Card, DataTable, Modal,InputError,Button },
    name:'User',
    props:{
        urlRoute:String,
